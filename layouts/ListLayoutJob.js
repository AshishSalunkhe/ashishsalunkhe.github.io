...
const jobDateTemplate = { year: 'numeric', month: 'long'}
      ...
      <div className="divide-y">
        ...
        <ul>
          ...
          {filteredBlogPosts.map((frontMatter) => {
            const { slug, date, title, startdate,location, enddate, summary, tags } = frontMatter
            return (
                ...
                <article className="space-y-2 xl:grid xl:grid-cols-4 xl:space-y-0 xl:items-baseline">
                  ...
                  <div className="space-y-3 xl:col-span-3">
                    <div>
                      ...
                      <dd className="text-base font-medium leading-6 text-green-500 dark:text-green-400">
                      {startdate}
                      <span> - </span>
                      {enddate}
                    </dd>
